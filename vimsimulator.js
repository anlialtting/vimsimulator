...
'use strict'
!function(){
window.Vimsimulator=Vimsimulator
function Vimsimulator(
    textarea,
    count_rows_toshow,
    count_cols_toshow
){
    var vimsimulator=this
    ...
    var textarea_onkeydown_mode_2=function(e){
        ...
        if(e.keyCode===37){ // left arrow
            value_toreturn=false
            vimsimulator.cursorMovesLeft()
        }else if(e.keyCode===38){ // up arrow
            value_toreturn=false
            vimsimulator.cursorMovesUp()
        }else if(e.keyCode===39){ // right arrow
            value_toreturn=false
            vimsimulator.cursorMovesRight()
        }else if(e.keyCode===40){ // down arrow
            value_toreturn=false
            vimsimulator.cursorMovesDown()
        }else if(65<=e.keyCode&&e.keyCode<91){ // a-z
            value_toreturn=false
            vimsimulator.command+=
                String.fromCharCode(e.keyCode+32)
        }else if(e.keyCode===188){ // <
            value_toreturn=false
            vimsimulator.command+='<'
        ...
        vimsimulator.runCommandIfPossible()
        return value_toreturn
    }
